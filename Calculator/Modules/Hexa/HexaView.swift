...
struct HexaView: View {
    ...
    var body: some View {
        CalculatorView(result: $decimalViewModel.result, expression: $decimalViewModel.expresion, keyboardType: .hexa, title: "Héxadécimal", onkeyPress: decimalViewModel.handleKeyPress(_:))
    }
}
